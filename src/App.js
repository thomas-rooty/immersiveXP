...
const Controls = () => {
  ...
  return <orbitControls ref={controls} args={[camera, gl.domElement]} enableDamping maxPolarAngle={2} minPolarAngle={0.8} dampingFactor={0.1} rotateSpeed={0.3} autoRotate={true} autoRotateSpeed={0.1} enableZoom={false} />
}
