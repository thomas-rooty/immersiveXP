...
const Intro = (props) => {
    ...
    const setActiveAsset = (e) => {
        ...
        props.value.handleChangeSection({ ...props.value, section: currentSection });
        if (activeProject) {
        ...
        return (
            <>
                <ul className='project-overview'>
                    <li onClick={setActiveAsset} className='active-project' >WHO</li>
                    <li onClick={setActiveAsset} >WHAT</li>
                    <li onClick={setActiveAsset} >WHERE</li>
                </ul>

                {props.value.section.section === "who" &&
